...
const PORTFOLIO_TEMPLATES: PortfolioTemplate[] = [
  ...
  },
  {
    id: "atlas",
    name: "Atlas",
    description: "Sans-style cobalt portfolio. Cursor-follow project index, slide-in nav, italic display marquee, and an accent-underlined year on the cover.",
    category: "Editorial",
    tags: ["Editorial", "Cobalt", "Italic"],
    href: "/template/atlas",
    seed: 800,
    new: true,
    fonts: { serif: "Bricolage Grotesque", sans: "Geist", mono: "Geist Mono" },
    style: { bg: "#EFEAE0", fg: "#0E0E0E", accent: "#2235FF", muted: "#6E6A60" },
    collection: "atlas",
  },
  {
    id: "vault",
    name: "Vault",
    description: "Paper-archive portfolio organised like a book — categories → folders → plates. Anton display, terracotta accent, table-of-contents index, auto-glide rails per folder.",
    category: "Magazine",
    tags: ["Magazine", "Archive", "Paper"],
    href: "/template/vault",
    seed: 900,
    new: true,
    fonts: { serif: "Anton", sans: "Manrope", mono: "JetBrains Mono" },
    style: { bg: "#F4F0E6", fg: "#1A1714", accent: "#A8462E", muted: "#857C68" },
    collection: "vault",
  },
];
...
const LINKS_TEMPLATES: LinksTemplate[] = [
  ...
  },
  {
    id: "links-atlas",
    name: "Atlas",
    description: "Centered cobalt-accented hub. Italic marquee, framed avatar, numbered link cards on warm cream, with arrow translate on hover.",
    tags: ["Editorial", "Cobalt", "Italic"],
    available: true, new: true,
    bg: "#EFEAE0", fg: "#0E0E0E", sub: "#6E6A60",
    btnStyle: "square", btnBg: "#2235FF", btnFg: "#FFFFFF", font: "Bricolage Grotesque",
    href: "/template/atlas/links",
    collection: "Atlas",
  },
  {
    id: "links-vault",
    name: "Vault",
    description: "Paper-archive link page with Anton display, terracotta accent on the primary CTA. Photographer mark, fixed top bar, divided stats row.",
    tags: ["Magazine", "Archive", "Paper"],
    available: true, new: true,
    bg: "#F4F0E6", fg: "#1A1714", sub: "#857C68",
    btnStyle: "square", btnBg: "#A8462E", btnFg: "#FFFFFF", font: "Anton",
    href: "/template/vault/links",
    collection: "Vault",
  },
  {
    id: "links-clean",
...
const DELIVERY_TEMPLATES: DeliveryTemplate[] = [
  ...
  },
  {
    id: "delivery-atlas",
    name: "Atlas",
    description: "Cobalt-tinted lock gate with curtain reveal into a masonry gallery. Sticky pill toolbar, fav-only filter, mobile floater, full-bleed lightbox.",
    tags: ["Editorial", "Cobalt", "Italic"],
    available: true, new: true,
    accent: "#2235FF", fg: "#0E0E0E", sub: "#6E6A60",
    href: "/template/atlas/delivery",
    collection: "Atlas",
  },
  {
    id: "delivery-vault",
    name: "Vault",
    description: "Paper archive client gallery. Photographic gate with terracotta CTA, sectioned chapters, four-column strict grid, dark thank-you footer.",
    tags: ["Magazine", "Archive", "Paper"],
    available: true, new: true,
    accent: "#A8462E", fg: "#1A1714", sub: "#857C68",
    href: "/template/vault/delivery",
    collection: "Vault",
  },
  {
    id: "delivery-minimal",
...
const COLLECTIONS: TemplateCollection[] = [
  ...
  },
  {
    id: "atlas",
    name: "Atlas",
    description: "Cobalt-accented sans collection. Cursor-follow project index, italic display marquee, lock-gate with curtain reveal, masonry delivery, centered links page — three pages on one warm-cream palette.",
    accentColor: "#2235FF",
    accentText:  "#FFFFFF",
    pages: [
      { type: "portfolio", href: "/template/atlas",          seed: 800 },
      { type: "links",     href: "/template/atlas/links",    seed: 801 },
      { type: "delivery",  href: "/template/atlas/delivery", seed: 802 },
    ],
  },
  {
    id: "vault",
    name: "Vault",
    description: "Paper archive collection built like a book. Anton display, terracotta accent, table-of-contents index with categories → folders → plates, auto-glide rails, dark colophon footer.",
    accentColor: "#A8462E",
    accentText:  "#FFFFFF",
    pages: [
      { type: "portfolio", href: "/template/vault",          seed: 900 },
      { type: "links",     href: "/template/vault/links",    seed: 901 },
      { type: "delivery",  href: "/template/vault/delivery", seed: 902 },
    ],
  },
  {
    id: "petal",
