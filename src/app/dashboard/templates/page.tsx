...
const PORTFOLIO_TEMPLATES: PortfolioTemplate[] = [
  ...
  },
  {
    id: "vernissage",
    name: "Vernissage",
    description: "A night-lit 3D exhibition — each spotlit photograph takes the wall facing the visitor, framed in walnut with a brass plaque; the rest recede into the dark. Pure CSS 3D.",
    category: "Story",
    tags: ["3D", "Night", "Immersive"],
    ...
    style: { bg: "#14171D", fg: "#EDEBE4", accent: "#C2A15E", muted: "#8A8E96" },
...
export default function TemplatesPage() {
  ...
  return (
    <div className="min-h-full">
      ...
      {/* Header */}
      <div className="bg-[var(--bg)] border-b border-[var(--border)] px-5 pt-4 pb-0">
