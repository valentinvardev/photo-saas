          ...
          <Section title="Your identity" description="How you appear in the community chat and across the platform.">
            <div className="px-6 py-5 flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="mt-1.5 font-sans text-[13px] text-[var(--fg-muted)]">Shown in the community chat and on your public portfolio URL.</p>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1 bg-yellow/10 border border-yellow/30 rounded-full px-2 py-0.5">
                    ...
                    <span className="font-mono text-[13px] text-yellow font-bold uppercase tracking-wider">Active</span>
                  </span>
                </div>
            ...
            <div className="px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-7 bg-[var(--bg-subtle)] border border-[var(--border)] rounded flex items-center justify-center">
                  <span className="font-mono text-[13px] font-bold text-[var(--fg-muted)]">VISA</span>
                </div>
                <div>
            ...
            {[
              ...
              <div key={inv.date} className="flex items-center justify-between px-6 py-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-[12px] bg-green-500/10 text-green-500 border border-green-500/20 px-2 py-0.5 rounded-full">
                    {inv.status}
                  </span>
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-[var(--border)] flex items-center justify-between">
              ...
              <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-[#009ee3]/10 border border-[#009ee3]/20">
                ...
                <span className="font-sans font-bold text-[13px] text-[#009ee3]">MercadoPago</span>
              </div>
            </div>
            <div className="px-6 py-5 flex flex-col gap-4">
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={f.label} className="flex flex-col items-center gap-1.5 bg-[var(--bg-subtle)] border border-[var(--border)] rounded-lg py-3 text-[var(--fg-muted)]">
                    {f.icon}
                    <span className="font-sans text-[13px]">{f.label}</span>
                  </div>
                ))}
              </div>
              ...
              <p className="font-sans text-[13px] text-[var(--fg-muted)] text-center">
          ...
          <Section title="Connected apps">
            {[
              ...
              <Row key={app.name} label={app.name} hint={app.desc}>
                <div className="flex items-center gap-3">
                  {app.connected && (
                    <span className="font-sans text-[12px] text-green-500 bg-green-500/10 border border-green-500/20 px-2 py-0.5 rounded-full">
                      Connected
                    </span>
                  )}
                  <button
