 ...
 * truth. Demo album pages come from the template's built-in fallback set.
 */
...
export default function SerenataDemoPage() {
  return <PortfolioSiteRender design={{ templateId: "serenata" }} galleryPhotos={[]} />;
}
