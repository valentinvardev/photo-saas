    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 14px", borderBottom: "1px solid #1a1a1a", flexShrink: 0 }}>
          <span style={{ color: "#888", fontSize: 11, textTransform: "uppercase", letterSpacing: "0.1em" }}>Select logo image</span>
            ...
            <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
              <button
                ...
                style={{
                  ...
                  color: selected ? "#666" : "#2a2a2a", fontSize: 11, padding: "8px",
                  borderRadius: 4, cursor: selected ? "pointer" : "default", fontFamily: "inherit",
              ...
              <button
                ...
                disabled={!selected}
                style={{
                  flex: 2, background: selected ? "#1a2a3a" : "#111",
...
function LogoImageButton({
  ...
  return (
    <>
      ...
      {open && <LogoGalleryModal value={value} onChange={onChange} onClose={() => setOpen(false)} />}
    </>
  );
}
          ...
          {(logo.mode === "image" || logo.mode === "image+text") && (
            <>
              <div>
                ...
                <LogoImageButton value={logo.imageUrl} onChange={(url) => setLogo({ imageUrl: url })} />
              </div>
              <div>
                <label style={labelStyle}>Alt logo (dark bg)</label>
                <LogoImageButton value={logo.altImageUrl} onChange={(url) => setLogo({ altImageUrl: url })} />
              </div>
            </>
          )}
          <div>
