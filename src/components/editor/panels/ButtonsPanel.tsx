    ...
    <div style={{ padding: "14px 14px 4px", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
          ...
          <span style={{ fontFamily: "monospace", fontSize: 13, color: "var(--ec-muted)" }}>{buttons.radius}px</span>
        </div>
        <input
      ...
      <div>
        ...
        {(buttons.bg || buttons.fg) && (
          <button
            ...
            style={{ marginTop: 10, background: "none", border: "1px solid var(--ec-lift)", color: "var(--ec-sub)", fontSize: 12, padding: "5px 10px", borderRadius: 4, cursor: "pointer", fontFamily: "inherit" }}
          >
      ...
      <div>
        ...
        <div style={{ background: palette.bg, borderRadius: 8, border: "1px solid var(--ec-raised)", display: "flex", alignItems: "center", justifyContent: "center", gap: 12, padding: 22, flexWrap: "wrap" }}>
          <button style={{ background: bg, color: fg, border: `1px solid ${bg}`, borderRadius: buttons.radius, padding: "10px 18px", fontSize: 13, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", cursor: "default" }}>
            Hire me
          </button>
          <button style={{ background: "transparent", color: bg, border: `1px solid ${bg}`, borderRadius: buttons.radius, padding: "10px 18px", fontSize: 13, fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase", cursor: "default" }}>
            About
          </button>
        </div>
      </div>
